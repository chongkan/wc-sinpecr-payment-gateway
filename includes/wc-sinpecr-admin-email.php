<?php
/*
	Plugin Name: WC SINPECR Store Order Confirmation Emailer
	Description: Registra y Habilida emails al vendedor
	Version: 2.2.0
...
class WC_SinpeCR_Expedited_Order_Email extends WC_Email {
...
function add_expedited_order_woocommerce_email( $email_classes ) {
    ...
    $email_classes['WC_Expedited_Order_Email'] = new WC_SinpeCR_Expedited_Order_Email();
